...
static const struct gate_clk nord_gcc_clks[] = {
	...
	GATE_CLK(GCC_PCIE_A_DTI_QTC_CLK,        0x9d008, BIT(0)),
	GATE_CLK(GCC_PCIE_A_MSTR_AXI_CLK,       0x9d008, BIT(0)),
	GATE_CLK(GCC_PCIE_A_PIPE_CLK,           0x9d008, BIT(0)),
	GATE_CLK(GCC_PCIE_B_DTI_QTC_CLK,        0x9d008, BIT(0)),
	GATE_CLK(GCC_PCIE_B_MSTR_AXI_CLK,       0x9d008, BIT(0)),
	GATE_CLK(GCC_PCIE_B_PIPE_CLK,           0x9d008, BIT(0)),
	GATE_CLK(GCC_PCIE_C_DTI_QTC_CLK,        0x9d008, BIT(0)),
	GATE_CLK(GCC_PCIE_C_MSTR_AXI_CLK,       0x9d008, BIT(0)),
	GATE_CLK(GCC_PCIE_C_PIPE_CLK,           0x9d010, BIT(0)),
	GATE_CLK(GCC_PCIE_D_DTI_QTC_CLK,        0x9d010, BIT(0)),
	GATE_CLK(GCC_PCIE_D_MSTR_AXI_CLK,       0x9d010, BIT(0)),
	GATE_CLK(GCC_PCIE_D_PIPE_CLK,           0x9d010, BIT(0)),
	GATE_CLK(GCC_PCIE_NOC_ASYNC_BRIDGE_CLK, 0x9d018, BIT(0)),
	GATE_CLK(GCC_PCIE_NOC_MSTR_AXI_CLK,     0x9d010, BIT(0)),
