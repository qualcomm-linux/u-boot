...
#include "phy-qcom-qmp-pcs-usb-v9.h"
...
static const unsigned int qmp_v9_usb3phy_regs_layout[QPHY_LAYOUT_SIZE] = {
	[QPHY_SW_RESET]			= QPHY_V9_PCS_SW_RESET,
	[QPHY_START_CTRL]		= QPHY_V9_PCS_START_CONTROL,
	[QPHY_PCS_STATUS]		= QPHY_V9_PCS_PCS_STATUS1,
	[QPHY_PCS_POWER_DOWN_CONTROL]	= QPHY_V9_PCS_POWER_DOWN_CONTROL,
...
static const struct qmp_usb_offsets qmp_usb_offsets_v9 = {
	.serdes		= 0,
	.pcs		= 0x0400,
	.pcs_usb	= 0x1200,
	.tx		= 0x0e00,
...
static const struct qmp_phy_init_tbl echo_usb3_uniphy_serdes_tbl[] = {
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_SSC_STEP_SIZE1_MODE1, 0x55),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_SSC_STEP_SIZE2_MODE1, 0x0E),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_CP_CTRL_MODE1, 0x02),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_PLL_RCTRL_MODE1, 0x16),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_PLL_CCTRL_MODE1, 0x36),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_CORECLK_DIV_MODE1, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_LOCK_CMP1_MODE1, 0x2e),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_LOCK_CMP2_MODE1, 0x82),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DEC_START_MODE1, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DEC_START_MSB_MODE1, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DIV_FRAC_START1_MODE1, 0x55),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DIV_FRAC_START2_MODE1, 0xd5),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DIV_FRAC_START3_MODE1, 0x05),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_HSCLK_SEL_1, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_VCO_TUNE1_MODE1, 0x25),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_VCO_TUNE2_MODE1, 0x02),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_BIN_VCOCAL_CMP_CODE1_MODE1, 0xb7),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_BIN_VCOCAL_CMP_CODE2_MODE1, 0x1e),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_BIN_VCOCAL_CMP_CODE1_MODE0, 0xb7),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_BIN_VCOCAL_CMP_CODE2_MODE0, 0x1e),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_SSC_STEP_SIZE1_MODE0, 0x55),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_SSC_STEP_SIZE2_MODE0, 0x0e),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_CP_CTRL_MODE0, 0x02),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_PLL_RCTRL_MODE0, 0x16),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_PLL_CCTRL_MODE0, 0x36),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_LOCK_CMP1_MODE0, 0x12),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_LOCK_CMP2_MODE0, 0x34),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DEC_START_MODE0, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DEC_START_MSB_MODE0, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DIV_FRAC_START1_MODE0, 0x55),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DIV_FRAC_START2_MODE0, 0xd5),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_DIV_FRAC_START3_MODE0, 0x05),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_VCO_TUNE1_MODE0, 0x25),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_VCO_TUNE2_MODE0, 0x02),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_BG_TIMER, 0x0e),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_SSC_EN_CENTER, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_SSC_PER1, 0x31),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_SSC_PER2, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_SYSCLK_BUF_ENABLE, 0x0c),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_SYSCLK_EN_SEL, 0x1a),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_LOCK_CMP_CFG, 0x14),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_VCO_TUNE_MAP, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_CORE_CLK_EN, 0x20),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_CMN_CONFIG_1, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_AUTO_GAIN_ADJ_CTRL_1, 0xb6),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_AUTO_GAIN_ADJ_CTRL_2, 0x4a),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_AUTO_GAIN_ADJ_CTRL_3, 0x36),
	QMP_PHY_INIT_CFG(QSERDES_V9_COM_ADDITIONAL_MISC, 0x0c),
};

static const struct qmp_phy_init_tbl echo_usb3_uniphy_tx_tbl[] = {
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_RES_CODE_LANE_TX, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_RES_CODE_LANE_RX, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_RES_CODE_LANE_OFFSET_TX, 0x1f),
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_RES_CODE_LANE_OFFSET_RX, 0x09),
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_LANE_MODE_1, 0xf5),
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_LANE_MODE_3, 0x1f),
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_LANE_MODE_4, 0x30),
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_LANE_MODE_5, 0x5f),
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_RCV_DETECT_LVL_2, 0x12),
	QMP_PHY_INIT_CFG(QSERDES_V9_TX_PI_QEC_CTRL, 0x21),
};

static const struct qmp_phy_init_tbl echo_usb3_uniphy_rx_tbl[] = {
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_FO_GAIN, 0x0b),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_SO_GAIN, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_FASTLOCK_FO_GAIN, 0x2f),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_SO_SATURATION_AND_ENABLE, 0x7f),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_FASTLOCK_COUNT_LOW, 0xff),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_FASTLOCK_COUNT_HIGH, 0x0f),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_PI_CONTROLS, 0x99),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_SB2_THRESH1, 0x08),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_SB2_THRESH2, 0x08),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_SB2_GAIN1, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_UCDR_SB2_GAIN2, 0x0a),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_AUX_DATA_TCOARSE_TFINE, 0x20),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_VGA_CAL_CNTRL1, 0x54),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_VGA_CAL_CNTRL2, 0x0f),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_GM_CAL, 0x1c),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_EQU_ADAPTOR_CNTRL2, 0x0e),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_EQU_ADAPTOR_CNTRL3, 0x4a),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_EQU_ADAPTOR_CNTRL4, 0x0a),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_IDAC_TSETTLE_LOW, 0x07),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_IDAC_TSETTLE_HIGH, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_EQ_OFFSET_ADAPTOR_CNTRL1, 0x27),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_SIGDET_ENABLES, 0x0c),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_SIGDET_CNTRL, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_SIGDET_DEGLITCH_CNTRL, 0x0e),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_00_LOW, 0xbf),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_00_HIGH, 0xbf),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_00_HIGH2, 0xbf),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_00_HIGH3, 0xdf),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_00_HIGH4, 0xeb),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_01_LOW, 0x19),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_01_HIGH, 0x09),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_01_HIGH2, 0x91),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_01_HIGH3, 0xb7),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_RX_MODE_01_HIGH4, 0xaa),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_DFE_EN_TIMER, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_DFE_CTLE_POST_CAL_OFFSET, 0x38),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_DCC_CTRL1, 0x0c),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_VTH_CODE, 0x10),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_SIGDET_CAL_CTRL1, 0x14),
	QMP_PHY_INIT_CFG(QSERDES_V9_RX_SIGDET_CAL_TRIM, 0x08),
};

static const struct qmp_phy_init_tbl echo_usb3_uniphy_pcs_tbl[] = {
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_LOCK_DETECT_CONFIG1, 0xc4),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_LOCK_DETECT_CONFIG2, 0x89),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_LOCK_DETECT_CONFIG3, 0x20),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_LOCK_DETECT_CONFIG6, 0x13),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_REFGEN_REQ_CONFIG1, 0x21),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_RX_SIGDET_LVL, 0x55),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_RCVR_DTCT_DLY_P1U2_L, 0xe7),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_RCVR_DTCT_DLY_P1U2_H, 0x03),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_CDR_RESET_TIME, 0x0a),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_ALIGN_DETECT_CONFIG1, 0xd4),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_ALIGN_DETECT_CONFIG2, 0x30),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_PCS_TX_RX_CONFIG, 0x0c),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_EQ_CONFIG1, 0x4b),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_EQ_CONFIG5, 0x10),
};

static const struct qmp_phy_init_tbl echo_usb3_uniphy_pcs_usb_tbl[] = {
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_USB3_LFPS_DET_HIGH_COUNT_VAL, 0xf8),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_USB3_RXEQTRAINING_WAIT_TIME_S2, 0x75),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_USB3_RXEQTRAINING_DFE_TIME_S2, 0x07),
	QMP_PHY_INIT_CFG(QPHY_V9_PCS_USB3_RCVR_DTCT_DLY_U3_L, 0x40),
};


static const struct qmp_phy_cfg echo_usb3_uniphy_cfg = {
	.offsets		= &qmp_usb_offsets_v9,

	.serdes_tbl		= echo_usb3_uniphy_serdes_tbl,
	.serdes_tbl_num		= ARRAY_SIZE(echo_usb3_uniphy_serdes_tbl),
	.tx_tbl			= echo_usb3_uniphy_tx_tbl,
	.tx_tbl_num		= ARRAY_SIZE(echo_usb3_uniphy_tx_tbl),
	.rx_tbl			= echo_usb3_uniphy_rx_tbl,
	.rx_tbl_num		= ARRAY_SIZE(echo_usb3_uniphy_rx_tbl),
	.pcs_tbl		= echo_usb3_uniphy_pcs_tbl,
	.pcs_tbl_num		= ARRAY_SIZE(echo_usb3_uniphy_pcs_tbl),
	.pcs_usb_tbl		= echo_usb3_uniphy_pcs_usb_tbl,
	.pcs_usb_tbl_num	= ARRAY_SIZE(echo_usb3_uniphy_pcs_usb_tbl),
	.vreg_list		= qmp_phy_vreg_l,
	.num_vregs		= ARRAY_SIZE(qmp_phy_vreg_l),
	.regs			= qmp_v9_usb3phy_regs_layout,
	.pcs_usb_offset		= 0xe00,
...
static const struct udevice_id qmp_usb_phy_ids[] = {
	{
		...
		.compatible = "qcom,echo-qmp-usb3-uni-phy",
		.data = (ulong)&echo_usb3_uniphy_cfg,
	}, {
